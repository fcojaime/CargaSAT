...
//Connection Settings @0-069B5743
$CCConnectionSettings = array (
    "con_xls" => array(
        "Type" => "MSSQLServer",
        "DBLib" => "ODBC",
        "Database" => "archivosxls_64",
        "Host" => "",
        "Port" => "",
        "User" => "sa",
        "Password" => "itera",
...
//Initialize Common Variables @0-548773A5
...
//CCLoginUser @0-E89D7401
function CCLoginUser($login, $password)
{
    CCLogoutUser();
    $db = new clsDBcon_xls();
    $SQL = "SELECT id_usuario, nivel, password FROM usuario WHERE usuario=" . $db->ToSQL($login, ccsText) . " AND password=" . $db->ToSQL($password, ccsText);
    $db->query($SQL);
